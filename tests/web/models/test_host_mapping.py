...
class HostMappingModelTest(TestCase):
    def test_host_mapping_creation(self):
        ...
        self.assertEqual(mapped_hosts_of_facebook[0].captured_host, captured_host_list[0])
        self.assertEqual(mapped_hosts_of_facebook[1].captured_host, captured_host_list[1])
